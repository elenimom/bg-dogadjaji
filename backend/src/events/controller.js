...
export function eventController(repository) {
  const categories = async (_req,res)=>res.json({categories:await repository.categories()});
  ...
  return { categories, list, details };
}
